...
title Stop KartMitra Development Services

echo ====================================================================
echo           KartMitra Development Services Shutdown
echo ====================================================================
echo.
echo Stopping development server processes [Ports: 8000, 3000, 5000, 5173]...
echo NOTE: PostgreSQL and MongoDB databases are preserved and left untouched.
echo.
...
:: [1] AI Verification Lab Backend (Port 8000)
...
:: [2] AI Verification Lab Frontend (Port 3000)
...
echo ====================================================================
echo           All KartMitra Development Services Stopped!
echo ====================================================================
echo.
pause
